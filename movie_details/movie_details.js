...
const extidsUrl =  `https://bingflix-backend.vercel.app/movies_details/extids/${movieId}`;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const movieId = getParameterByName('id');
    const movieDetailsUrl = `https://bingflix-backend.vercel.app/movies_details/${movieId}`;
    const castUrl = `https://bingflix-backend.vercel.app/movies_details/credits/${movieId}`;
    const videosUrl = `https://bingflix-backend.vercel.app/movies_details/videos/${movieId}`;
